 ...
 * Copyright (c) 2025 빈센
 *
 * 이 소프트웨어는 "있는 그대로(as is)" 제공되며, 사용, 복사, 수정, 병합, 게시, 배포, 서브라이선스 및 판매가 자유롭게 허용됩니다.
 * 단, 위 저작권 고지와 이 라이선스 고지를 모든 복제본 또는 실질적인 부분에 포함해야 합니다.
 * 이 소프트웨어는 상품성, 특정 목적에의 적합성, 비침해성에 대한 보증 없이 제공됩니다.
 */
